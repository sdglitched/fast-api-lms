...
Revision ID: b3396d8a1710
Revises: 
Create Date: 2023-11-05 14:03:52.273885
...
def upgrade() -> None:
    ...
    # ### commented below line due to issue with enum and added with normal creation above
    op.add_column(
        'users',
        sa.Column('role', sa.Enum('teacher', 'student', name='role'), nullable=True),
    )
    ...
    sa.Column('title', sa.String(length=200), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    # ### commented below line due to issue with enum
